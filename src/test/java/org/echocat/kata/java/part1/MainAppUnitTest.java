...
public class MainAppUnitTest {
    ...
    public void testReadAuthors() {
        final Set<Author> authors = MainApp.readAuthors(new HashSet<Author>());
    ...
    public void testReadBooks() {
        ...
        MainApp.readMedia(books, MainApp.readAuthors(new HashSet<Author>()), MainApp::parseBook, "/org/echocat/kata/java/part1/data/books.csv");
    ...
    public void testReadMagazins() {
        ...
        MainApp.readMedia(magazines, MainApp.readAuthors(new HashSet<Author>()), MainApp::parseMagazine, "/org/echocat/kata/java/part1/data/magazines.csv");
